...
import static com.qcoders.adscodenew.AD.Nativead;
import static com.qcoders.adscodenew.AD.fbnativead;
...
public class Nativad {
    ...
    public Nativad(Activity mActivity, FrameLayout mLayout) {
